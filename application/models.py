...
class temp_doc_create(models.Model):
    tem_Document_no = models.CharField(max_length=200,primary_key=True)
    ...
    temp_remarks_Subject1 = models.CharField(max_length=100,blank=True,null=True)
    temp_Priority = models.CharField(max_length=100)
    temp_fin_commit = models.CharField(max_length=100)
    temp_staff_id = models.CharField(max_length=10,blank=True,null=True)
    temp_Tolerance = models.CharField(max_length=100)
    temp_Total_Value = models.CharField(max_length=100,blank=True,null=True)
    temp_In_words = models.CharField(max_length=200,blank=True,null=True)
    temp_creator=models.CharField(max_length=200,blank=True,null=True)
    temp_Attachment = models.FileField(upload_to='')
    temp_date = models.DateField()
    temp_Attachment_details = models.CharField(max_length=100,blank=True,null=True)